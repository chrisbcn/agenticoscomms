      ...
      <div className="absolute bg-[#f9f9f9] h-[888px] left-0 overflow-clip rounded-bl-[50px] rounded-br-[50px] top-0 w-[480px]">
        ...
        <div className="absolute bg-white h-[529px] left-[24px] overflow-clip rounded-[40px] shadow-[2px_2px_10px_5px_rgba(164,164,164,0.25)] top-[246px] w-[432px]">
          ...
          <div className="absolute h-[208px] left-[20px] overflow-clip rounded-[20px] top-[105px] w-[392px]">
            <div className="absolute h-[226px] left-0 top-[-9px] w-[392px] overflow-hidden">
              <img
                alt=""
                className="absolute h-[113.72%] left-[-0.06%] max-w-none top-[-10.33%] w-[100.13%]"
                src={imgRestaurant}
              />
            </div>
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(-0.785904deg, rgba(0, 0, 0, 0) 2.7614%, rgb(0, 0, 0) 97.138%)",
              }}
            >
              <p
          ...
          {/* Family avatars */}
          <div className="absolute left-[20px] rounded-[500px] size-[24px] top-[333px] overflow-hidden">
            <img alt="" className="absolute left-[-54.55%] max-w-none size-[206.87%] top-[-22.19%]" src={imgMom} />
          </div>
          <div className="absolute h-[24px] left-[38px] rounded-[500px] top-[333px] w-[25px] overflow-hidden">
            <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[500px] size-full" src={imgUser} />
          </div>
          <div className="absolute left-[58px] rounded-[500px] size-[24px] top-[333px] overflow-hidden">
            <img
              alt=""
              className="absolute left-[-38.92%] max-w-none size-[181.56%] top-[-5.88%]"
              src={imgAaron}
            />
          </div>
          ...
          {/* Address */}
          <p
            className="absolute left-[92px] text-[#4c4c4c] text-[14px] top-[333px] whitespace-nowrap"
          ...
          {/* Agent note */}
          <div className="absolute left-[48px] rounded-[500px] size-[28px] top-[380px] overflow-hidden">
            <img
              alt=""
          ...
          <p
            className="absolute left-[92px] text-[#7e7e7e] text-[14px] top-[380px] w-[292px]"
            style={{ fontFamily: "'One UI Sans APP VF', system-ui, sans-serif", fontWeight: 300, lineHeight: 1.2 }}
          >
            You always go grilled fish, the branzino here is the call. And you always share dessert: I recommend the
            pastel de nata.
          </p>
